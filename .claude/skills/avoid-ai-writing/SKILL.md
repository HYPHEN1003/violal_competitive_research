...
description: Audit and rewrite content to remove AI writing patterns ("AI-isms"). Use when asked to "remove AI-isms," "clean up AI writing," "audit writing for AI tells," "make this sound less like AI," "AI臭を消して," "AIっぽさを取って," "文章を自然にして," "人間らしく書き直して," or "ライティングチェック." Supports detect-only mode (flag without rewriting). English content only — 日本語は対象外。
version: 3.3.0
license: MIT
